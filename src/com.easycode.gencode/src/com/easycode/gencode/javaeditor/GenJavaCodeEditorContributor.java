		...
		sampleAction = new Action() {
			public void run() {
				...
				if(part instanceof GenJavaCodeEditor)
				{
                    ...
                    Map map = javaEditor.getSrcJson();
					List<DefaultAnno> annoList = ConfigParseUtil.parse(annoCtxt,map);
                    //List<DefaultAnno> annoList = ConfigParseUtil.parse(annoCtxt,new HashMap<String ,Object>());
					if(template != null)
					{
