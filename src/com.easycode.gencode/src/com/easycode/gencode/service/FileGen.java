...
import com.easycode.gencode.service.ftlmethod.FiltMatch;
import com.easycode.gencode.service.ftlmethod.FiltNotMatch;
 
import com.easycode.gencode.service.ftlmethod.QueryByPath;
import com.easycode.gencode.ui.elements.CheckBox;
...
/**
 * 功能描叙: 编 码: ouyangchao 完成时间: 2011-11-9 下午10:45:12
 */
public class FileGen
{
	...
	public void setDefinePara(String defineParaSrc) throws Exception
	{
		if(defineParaSrc != null)
		{
			if(!"".equals(defineParaSrc.trim()))
			{
				...
				try
				{
				Map<String,String> map = SrcUtil.josnToMap(definePara);
				this.defineObj = map;
        ...
        if (definePara != null)
        {
            if (!"".equals(definePara.trim()))
            {
                try
                {
                    ...
                    usermap = SrcUtil.josnToMap(definePara);
	...
	public HashMap<String, SelectCheckBox> getNodeTreeMap(String key)
	{
		HashMap<String,SelectCheckBox> retMap = new HashMap<String,SelectCheckBox>();
		SelectCheckBox node = checkedBoxMap.get(key);
		if(node == null)
		{
			return retMap;
		}
		...
		{
			SelectCheckBox parent = node.getParent(); 
			List<SelectCheckBox> childList = new ArrayList<SelectCheckBox>();
	...
	public HashMap<String, SelectCheckBox> getCheckedBoxMap()
	{
