 ...
 */
public class NewTemplateDialog extends Dialog implements MouseListener
{
	...
	// 是否点击保存到服务器按钮 
	public NewTemplateDialog(Shell parent, String templateType, String projectPath,Config config,MainUi rd)
	{
	...
	public NewTemplateDialog(Shell parent,Config config , String templateType)
		{
	...
	protected void createContents()
	{
        ...
        codeSrc.setText(getResource("/com/easycode/gencode/action/init.ftl"));
    ...
    public static String getResource(String path)
    {
        ...
        InputStream is = NewTemplateDialog.class
	 ...
	 public static class TypeSelect implements SelectionListener{
